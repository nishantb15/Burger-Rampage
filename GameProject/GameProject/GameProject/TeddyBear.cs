    ...
    public class TeddyBear
    {
        ...
        public void Update(GameTime gameTime)
        {
            ...
            if (elapsedShotMilliseconds > firingDelay)
            {
                ...
                firingDelay = GetRandomFiringDelay();
                //shootSound.Play();
                Projectile teddyBear = new Projectile(ProjectileType.TeddyBear, Game1.GetProjectileSprite(ProjectileType.TeddyBear),
                    drawRectangle.X - GameConstants.TeddyBearProjectileOffset, drawRectangle.Y - GameConstants.TeddyBearProjectileOffset, 
